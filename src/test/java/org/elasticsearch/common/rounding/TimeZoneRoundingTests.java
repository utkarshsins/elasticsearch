...
public class TimeZoneRoundingTests extends ElasticsearchTestCase {
    ...
    public void testUTCMonthRounding() {
        Rounding tzRounding = TimeZoneRounding.builder(DateTimeUnit.MONTH_OF_YEAR).preZone(DateTimeZone.forOffsetHoursMinutes(5, 30)).preOffset(19800000).build();
        Rounding tzRoundingUsingPreOffset = TimeZoneRounding.builder(DateTimeUnit.MONTH_OF_YEAR).preOffset(2 * 19800000).build();
        assertThat(tzRounding.round(utc("2009-02-03T01:01:01")), equalTo(tzRoundingUsingPreOffset.round(utc("2009-02-03T01:01:01"))));
        assertThat(tzRounding.nextRoundingValue(utc("2009-02-03T01:01:01")), equalTo(tzRoundingUsingPreOffset.nextRoundingValue(utc("2009-02-03T01:01:01"))));
