...
/**
 */
public class QueryCacheStats implements Streamable, ToXContent, FromXContentObject {
    ...
    public void readFrom(XContentObject in) throws IOException {
        ...
        this.hitCount = in.getAsLong(Fields.HIT_COUNT.underscore().getValue());
        this.missCount = in.getAsLong(Fields.MISS_COUNT.underscore().getValue());
    }
