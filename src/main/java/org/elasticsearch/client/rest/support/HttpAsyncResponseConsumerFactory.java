...
import org.elasticsearch.client.rest.support.HeapBufferedAsyncResponseConsumer;
import org.elasticsearch.common.unit.ByteSizeUnit;
import org.elasticsearch.common.unit.ByteSizeValue;

import static org.elasticsearch.client.rest.support.HttpAsyncResponseConsumerFactory.HeapBufferedResponseConsumerFactory.DEFAULT_BUFFER_LIMIT;
...
interface HttpAsyncResponseConsumerFactory {
    ...
    class HeapBufferedResponseConsumerFactory implements HttpAsyncResponseConsumerFactory {
        ...
        static final ByteSizeValue DEFAULT_BUFFER_LIMIT = new ByteSizeValue(100, ByteSizeUnit.MB);

        private final ByteSizeValue bufferLimit;

        public HeapBufferedResponseConsumerFactory(ByteSizeValue bufferLimitBytes) {
